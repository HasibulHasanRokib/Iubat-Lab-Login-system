...
import {  SIGNOUT_SUCCESS } from "../features/userSlice";
import Spinner from "./Spinner";
    ...
    return (
    <header className='flex justify-between border-2 p-3 bg-white'>
    <div className="flex flex-col max-w-[12rem] justify-start items-start gap-1">
      ...
      {show===true ? (
        ...
        <input type="password" onChange={(e)=>setPassword(e.target.value)} value={password} className="border outline-slate-300 px-2" placeholder="Enter password" />
